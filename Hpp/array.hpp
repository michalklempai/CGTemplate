  ...
  template <typename T> void arraY<T>::inserT( DWORD i, T elem_, DWORD numtimes ) {
      ...
      if( elem ) {  
          ...
          b = num+numtimes;
          if( b > (DWORD)pow( 2.0, flooR( log( (double)num )*INV_LN2 )+1.0 )-1 ) {
              elem = (T*)realloc( elem, ( (DWORD)pow( 2.0, flooR( log( (double)b )*INV_LN2 )+1.0 )-1 )*sizeof( T ) );
          ...
          // num = 0
          elem = (T*)malloc( ( (DWORD)pow( 2.0, flooR( log( (double)numtimes )*INV_LN2 )+1.0 )-1 )*sizeof( T ) );
          if( !elem ) exit( EXIT_FAILURE );
  ...
  template <typename T> void arraY<T>::deletE( DWORD i ) {
      if( elem ) {
          if( num == 1 ) {
              ...
              if( (DWORD)flooR( log( (double)num )*INV_LN2 ) > (DWORD)flooR( log( (double)( num-1 ) )*INV_LN2 ) ) {
                  elem = (T*)realloc( elem, ( (DWORD)pow( 2.0, flooR( log( (double)( num-1 ) )*INV_LN2 )+1.0 )-1 )*sizeof( T ) );
                  if( !elem ) exit( EXIT_FAILURE );
              }
  ...
  template <typename T> void arraY<T>::copY( arraY *elema ) {
      if( elema ) {
	      ...
	      if( elem ) {
              elema->elem = (T*)malloc( ( (DWORD)pow( 2.0, flooR( log( (double)num )*INV_LN2 )+1.0 )-1 )*sizeof( T ) );
